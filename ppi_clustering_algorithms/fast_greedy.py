...
def run_fast_greedy(G):
    """Runs the Fast Greedy Modularity community detection algorithm."""
    if not G.nodes():
        return []
    ...
    print("Running Fast Greedy Modularity algorithm...")
    try:
        ...
        raise RuntimeError(f"Fast Greedy Modularity clustering failed: {e}")
